    ...
    <div className="space-y-10 py-4">
      <div className="relative overflow-hidden bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link 
              href="/vehicles" 
              className="px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-200 active:scale-95"
            >
              Get Started
            </Link>
            <Link 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={feature.title} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:border-blue-100 transition-colors">
